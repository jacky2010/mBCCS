...
public class MultiDirectionSlidingDrawer extends ViewGroup {
    ...
    private int mHeaderOneId;
    private int mHeaderTwoId;
    private View mHeaderOpen;
    ...
    public interface OnDrawerScrollListener {
        void onScrollStarted(View v);

        void onScrollEnded(View v);
    }
    ...
    public MultiDirectionSlidingDrawer(Context context, AttributeSet attrs, int defStyle) {
        ...
        int headerIdTwo = a.getResourceId(R.styleable.MultiDirectionSlidingDrawer_handleTwo, 0);
        if (headerIdTwo == 0) {
            throw new IllegalArgumentException("The handle attribute is required and must refer "
                    + "to a valid child.");
        }
        ...
        mHeaderTwoId = headerIdTwo;
        mHeaderOneId = headerIdOne;
    ...
    protected void onFinishInflate() {
        ...
        mHeaderOpen = findViewById(mHeaderOneId);
        mHeaderClose = findViewById(mHeaderTwoId);

        mHeaderOpen.setVisibility(GONE);
        mHeaderClose.setVisibility(VISIBLE);
...
//                Log.d(LOG_TAG, "content.layout(1)");
    ...
    public boolean onInterceptTouchEvent(MotionEvent event) {
        ...
        if (action == MotionEvent.ACTION_DOWN) {
            if (!mExpanded) {
                ...
                mHeaderClose.setVisibility(INVISIBLE);
            }
            mTracking = true;
            ...
            if (mOnDrawerScrollListener != null) {
                mOnDrawerScrollListener.onScrollStarted(mHandle);
            }
    ...
    private void stopTracking() {
        ...
        if (mOnDrawerScrollListener != null) {
            mOnDrawerScrollListener.onScrollEnded(mHandle);
        }
    ...
    public void animateClose() {
        ...
        if (scrollListener != null) {
            scrollListener.onScrollStarted(mHandle);
        }
        animateClose(mVertical ? mHandle.getTop() : mHandle.getLeft());

        if (scrollListener != null) {
            scrollListener.onScrollEnded(mHandle);
        }
    }
