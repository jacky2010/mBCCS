...
import com.viettel.mbccs.screen.sellretail.savetransconfirm.SaveTransConfirmFragment;
...
public class PaymentInforRetailFragment extends BaseFragment
    ...
    public void goToSaveTransConfirm(BaseRequest<GetInfoSaleTranRequest> request, SaleTrans saleTrans) {
        getActivity().getSupportFragmentManager()
                ...
                .replace(R.id.container, SaveTransConfirmFragment.newInstance(request, saleTrans))
                .commit();
    }
}
