...
public class WsCode {
    ...
    // 5.1.3.2
    public final static String GetStockTotal = "WS_GetStockTotal";

    // 5.1.3.3
    public final static String GetListSerial = "WS_GetListSerial";

    // 5.1.3.4
    public final static String CreateSaleTransRetail = "WS_CreateSaleTransRetail";

    // 5.1.3.4 - 5.5.3.2
    public final static String GetSaleTransInfo = "WS_getSaleTransInfo";

    // 5.2.3.1
    public final static String GetInfoChannel = "WS_GetInfoChannel";
    ...
    // 5.4.3.2
    public final static String GetVasInfo = "WS_GetVasInfo";

    // 5.4.3.3
    public final static String RegisterVas = "WS_RegisterVas";
    ...
    // 5.8.3.3
    public final static String GetListProvince = "WS_getListProvince ";

    // 5.8.3.4
    public final static String GetListTTKD = "WS_getListTTKD";
